...
随着这颗卫星的转动，栖息于此的生物悄然苏醒，对云层外的世界一无所知，因为这里早已是它们世世代代以来的家园。

咔哒敲击声和羽毛的轻微颤动声清晰可闻，只有风声和摇曳的异星植物能将其削弱一部分。
生物在冰雪上奔跑，身后是由钢铁和塑料组成的机器。科技在世界各地安静地运转着，并由一群自称 Avali 的冰猛禽掌控。
...
Avali 是一种长有羽毛的小型生物，长得很像猛禽，有着两对耳朵用来感知世界（\TranslatorNote{辨别方位、感知环境等}）。
虽然长有眼睛，但耳朵才是主要的感官。
这些生物经常成群出现。可爱的外表让大多数旁观者觉得它们毫无威胁。但它们那锋利的爪子和牙齿不可小觑。
...
随着 Iubati 物种在2010年的持续发展，Ryuujin 随后将 Iubati 物种拆分为两个亚种：Elysiii 和 Avali。
虽然它们在本质上几乎完全相同且可以互换，但这两个种族之间的关键区别在于它们演化所处的宇宙核心星区以及各自的文化。
...
\SubSectionTitle{一个星系正待探索}

\AddToShipoutPictureBG*{
	\put(\dimexpr\paperwidth-0.7\paperwidth-1cm\relax,-2cm){
		\includegraphics[width=0.8\paperwidth]{chapters/chapter1/ICE_AND_FEATHER/assets/A_Galaxy_Awaits_Background.png}
	}
}
