...
\begin{wrapfigure}{r}{0.52\textwidth}
	\vspace{-1.5em}
	\centering
	\includegraphics[width=0.25\textwidth]{chapters/chapter1/BIOLOGY/assets/Smelling/Anterior_Brain.png}%
	\hspace{0.01\textwidth}
	\includegraphics[width=0.25\textwidth]{chapters/chapter1/BIOLOGY/assets/Smelling/Top_Brain.png}
...
Avali 进化出了致密且部分中空的骨骼，以承受飞行时的压力，同时又不会增加不必要的重量。
骨骼内部复杂的网状结构既能输送血液，又能提供结构上的刚性。
与地球鸟类不同，Avali 的骨骼不允许空气通过进行呼吸。
Avali 的某些部位，例如翅膀上宽大的初级飞羽和尾巴，由柔韧而坚韧的软骨支撑。
Avali 的骨骼主要由二氧化硅构成。
